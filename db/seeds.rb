...
item13 = Item.create(name: 'Cardinal cottage' , description: 'Add a pop of color to the backyard with this charming red birdhouse', image: 'https://images.pexels.com/photos/14719224/pexels-photo-14719224.jpeg?auto=compress&cs=tinysrgb&w=800', price: 35)
...
item18 = Item.create(name: 'Little yellow cottage' , description: 'Bring sunshine and style to the backyard with this cute yellow birdhouse featuring a green door', image: 'https://media.istockphoto.com/id/144228860/photo/birdsnest-with-bird-feeding.jpg?s=612x612&w=0&k=20&c=DVfVA0y9reNhmselOy1PcaSOhqK13hf26D3U7M2mdms=', price: 40)
